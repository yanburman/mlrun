...
async def create_alert(
    ...
    return await run_in_threadpool(
        server.api.crud.Alerts().create_alert,
        db_session,
        name,
        project,
        alert_data,
...
async def get_alert(
    ...
    resp = await run_in_threadpool(
        server.api.crud.Alerts().get_enriched_alert_by_id, db_session, alert_id
    )
...
async def delete_alert(
    ...
    await run_in_threadpool(
        server.api.crud.Alerts().delete_alert, db_session, project, alert_id
    )
...
async def reset_alert(
    ...
    return await run_in_threadpool(
        server.api.crud.Alerts().reset_alert, db_session, project, alert_id
    )
