...
class Notifications(
    ...
    def store_run_notifications(
        ...
        server.api.utils.singletons.db.get_db().store_run_notifications(
    ...
    def delete_run_notifications(
        ...
        server.api.utils.singletons.db.get_db().delete_run_notifications(
    ...
    def set_object_notifications(
        ...
        set_notification_methods = {
            "run": {
                "factory": server.api.utils.singletons.db.get_db,
                "method_name": server.api.db.sqldb.db.SQLDB.set_run_notifications.__name__,
                "identifier_key": "uid",
            },
            "schedule": {
                "factory": server.api.utils.singletons.scheduler.get_scheduler,
                "method_name": server.api.utils.scheduler.Scheduler.set_schedule_notifications.__name__,
                "identifier_key": "name",
            },
        }
